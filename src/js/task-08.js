...
//  полей формы методом reset.
 ...
 const inputName = document.querySelector('[name="email"]');
 ...
 function onFormSubmit(event){
    ...
    info.email = inputName.value;
    info.password = inputPass.value;
    console.log(info);

    event.currentTarget.reset();

//  console.log(`Name: ${info.email}, Password: ${ info.password}`);
 }